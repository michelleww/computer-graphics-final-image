...
Usage:
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    for(int i = 0;i<6;i++)
    {
      glUniform1i(glGetUniformLocation(prog_id, "is_light_1"), i==1);
      glUniform1i(glGetUniformLocation(prog_id, "is_light_2"), i==2);
      glUniform1i(glGetUniformLocation(prog_id, "is_light_3"), i==3);
      glUniform1i(glGetUniformLocation(prog_id, "is_light_4"), i==4);
      glUniform1i(glGetUniformLocation(prog_id, "is_light_5"), i==5);
